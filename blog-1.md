...
TypeScript শেখার শুরুতে আমি অনেক সময় `any` টাইপ ব্যবহার করতাম কারণ এটা খুব সহজ মনে হতো। কারণ সেখানেযেকোনো ধরনের data এখানে রাখা যেত এবং কোনো error দিত না। কিন্তু পরে বুঝতে পারলাম, `any` ব্যবহার করলে TypeScript এর সবচেয়ে বড় সুবিধা type safety নষ্ট হয়ে যায়। এজন্য একে বলা হয় “type safety hole”।
